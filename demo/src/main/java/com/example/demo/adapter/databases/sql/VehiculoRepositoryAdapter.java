...
import com.example.demo.adapter.databases.sql.entity.*;
import com.example.demo.adapter.databases.sql.mappers.*;
import com.example.demo.adapter.databases.sql.repository.*;
